...
```
**Remplacer par du vrai art** : dépose ton image au **même chemin** (ex. `assets/img/works/games/lumbra.svg`
...
Envoi d'e-mails réel via **FormSubmit.co** vers `contact@geeklearngames.com`.
