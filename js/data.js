...
const GAMES = [
  ...
  },
  {
    ...
    i18n:{
      fr:{ tagline:'Meurs. Apprends. Relève-toi. Rachète-toi.', description:['SOUL REDEMPTION est un action-roguelite dans lequel vous incarnez une âme condamnée combattant à travers sept chambres d’un purgatoire qui s’adapte à vos péchés. Chaque partie se termine par la mort — mais la mort est le professeur, et vous emportez ses leçons.','Un système de combat profond fondé sur le timing de la parade et les capacités élémentaires de l’âme, superposé à des chambres réordonnées à chaque partie et un récit en permadeath qui se ramifie selon votre façon de mourir. L’histoire ne prend sens qu’après de nombreuses morts.'], features:['Combat à base de parades avec une vraie profondeur et une vraie marge de progression','Récit en permadeath — vos choix de mort façonnent le lore','7 types de chambres, chacun avec des règles et une esthétique uniques','60+ capacités de l’âme à découvrir et combiner','Fragments de lore procéduraux révélés à travers plusieurs parties','Le mode New Game+ transforme entièrement l’expérience'] },
  ...
  },
  {
    ...
    i18n:{
      fr:{ tagline:'Vous ne devez pas faire le moindre bruit.', description:['HUSH! est un jeu d’infiltration et de réflexion dont le silence est la seule règle. Quelque chose rôde qui ne peut pas voir — mais seulement entendre. Chaque pas, chaque objet renversé, chaque souffle au mauvais moment est une condamnation à mort.','À travers 40 niveaux faits à la main dans un manoir victorien qui craque, une bibliothèque inondée, et un immeuble brutaliste la nuit, HUSH! bâtit un langage de tension et de silence qui n’a aucun équivalent dans le genre.'], features:['40 niveaux artisanaux à travers 4 environnements distincts','Prise en charge réelle du micro — votre voix peut déclencher les ennemis (optionnel)','Pas de musique — design sonore entièrement procédural','Mode accessibilité avec signaux visuels audio pour les joueurs sourds','Classements mondiaux de speedrun avec replay fantôme','Éditeur de niveaux (PC uniquement) avec partage Steam Workshop'] },
...
const TROPHIES = {
  ...
  'soul-redemption':[
    {code:'push_breaks',tier:'bronze',en:{t:'Push Until It Breaks',d:'Survive the schoolyard.'}, fr:{t:'Jusqu’à ce que ça casse',d:'Survis à la cour de récré.'}},
    {code:'eagle_eye',tier:'silver',en:{t:'Eagle Eye',d:'Spot every hidden detail in Childhood.'}, fr:{t:'Œil de lynx',d:'Repère chaque détail caché de l’Enfance.'}},
    {code:'smile_lies',tier:'bronze',en:{t:'The Smile That Lies',d:'See through the friendly mask.'}, fr:{t:'Le sourire qui ment',d:'Perce le masque amical à jour.'}},
    {code:'no_fear',tier:'silver',en:{t:'No Fear!',d:'Face the bully without flinching.'}, fr:{t:'Sans peur !',d:'Affronte la brute sans trembler.'}},
    {code:'too_cool',tier:'bronze',en:{t:'Too Cool for School',d:'Finish the School chapter.'}, fr:{t:'Trop cool pour l’école',d:'Termine le chapitre de l’École.'}},
    {code:'playtime',tier:'bronze',en:{t:'It’s Playtime!',d:'Enter Funland for the first time.'}, fr:{t:'C’est l’heure de jouer !',d:'Entre à Funland pour la première fois.'}},
    {code:'good_times',tier:'bronze',en:{t:'Let the Good Times Roll',d:'Ride every attraction.'}, fr:{t:'Que la fête commence',d:'Essaie toutes les attractions.'}},
    {code:'sneaky_fox',tier:'silver',en:{t:'Sneaky as a Fox',d:'Slip past the mascots unseen.'}, fr:{t:'Rusé comme un renard',d:'Faufile-toi sans être vu des mascottes.'}},
    {code:'thrill_seeker',tier:'bronze',en:{t:'Thrill Seeker',d:'Take the ride nobody dares to take.'}, fr:{t:'Chasseur de sensations',d:'Monte dans le manège que personne n’ose prendre.'}},
    {code:'smashed',tier:'bronze',en:{t:'Smashed Potatoes!',d:'Win the smashing game.'}, fr:{t:'Chamboule-tout !',d:'Gagne au jeu de massacre.'}},
    {code:'disguise',tier:'silver',en:{t:'Master of Disguise',d:'Fool Funland in costume.'}, fr:{t:'Maître du déguisement',d:'Trompe Funland sous un déguisement.'}},
    {code:'beast_whisper',tier:'bronze',en:{t:'Beast Whisperer',d:'Calm the carousel beast.'}, fr:{t:'Celui qui murmure aux bêtes',d:'Apaise la bête du carrousel.'}},
    {code:'back_future',tier:'bronze',en:{t:'Back to the Future',d:'Repair the time attraction.'}, fr:{t:'Retour vers le futur',d:'Répare l’attraction temporelle.'}},
    {code:'jackpot',tier:'bronze',en:{t:'Jackpot!',d:'Hit the jackpot at the arcade booth.'}, fr:{t:'Jackpot !',d:'Décroche le jackpot au stand.'}},
    {code:'one_down',tier:'silver',en:{t:'One Down, More to Go',d:'Close the Funland chapter.'}, fr:{t:'Et d’un !',d:'Referme le chapitre de Funland.'}},
    {code:'quick_flash',tier:'silver',en:{t:'Quick as a Flash',d:'Beat the reflex challenge.'}, fr:{t:'Rapide comme l’éclair',d:'Bats le défi de réflexes.'}},
    {code:'tech_guru',tier:'bronze',en:{t:'Tech Guru',d:'Hack every terminal in Technotown.'}, fr:{t:'Gourou de la tech',d:'Pirate tous les terminaux de Technotown.'}},
    {code:'shocking',tier:'bronze',en:{t:'Shocking, Isn’t It?',d:'Survive the surge.'}, fr:{t:'Choquant, non ?',d:'Survis à la surtension.'}},
    {code:'oops_again',tier:'bronze',en:{t:'Oops, I Did It Again!',d:'Fail the same trap twice.'}, fr:{t:'Oups, je l’ai refait !',d:'Retombe deux fois dans le même piège.'}},
    {code:'game_over',tier:'bronze',en:{t:'Game Over, Man!',d:'See every ending of the arcade.'}, fr:{t:'Game over, mec !',d:'Vois toutes les fins de la borne.'}},
    {code:'victory_royale',tier:'gold',en:{t:'Victory Royale!',d:'Win the tournament of Technotown.'}, fr:{t:'Top 1 !',d:'Gagne le tournoi de Technotown.'}},
    {code:'no_rest',tier:'silver',en:{t:'No Rest for the Wicked',d:'Clear the Cybercafe without pausing.'}, fr:{t:'Pas de repos pour les braves',d:'Nettoie le Cybercafé sans pause.'}},
    {code:'not_grandma',tier:'bronze',en:{t:'Not My Grandma',d:'Discover who really lives here.'}, fr:{t:'Pas ma mamie',d:'Découvre qui vit vraiment ici.'}},
    {code:'hungry_wolf',tier:'silver',en:{t:'Hungry Like the Wolf',d:'Escape the hunt in the woods.'}, fr:{t:'Une faim de loup',d:'Échappe à la traque dans les bois.'}},
    {code:'forest_calling',tier:'bronze',en:{t:'The Forest is Calling',d:'Answer the voice between the trees.'}, fr:{t:'La forêt t’appelle',d:'Réponds à la voix entre les arbres.'}},
    {code:'big_teeth',tier:'bronze',en:{t:'What Big Teeth You Have!',d:'Look the wolf in the eyes.'}, fr:{t:'Comme tu as de grandes dents !',d:'Regarde le loup dans les yeux.'}},
    {code:'a_to_b',tier:'silver',en:{t:'A to B, No Detours',d:'Cross the woods without straying.'}, fr:{t:'De A à B, sans détour',d:'Traverse les bois sans t’écarter.'}},
    {code:'better_luck',tier:'bronze',en:{t:'Better Luck Next Time',d:'Lose a game you were meant to lose.'}, fr:{t:'Ça ira mieux la prochaine fois',d:'Perds une partie perdue d’avance.'}},
    {code:'fears_under_sea',tier:'bronze',en:{t:'20,000 Fears Under the Sea',d:'Descend into the Deep Seas.'}, fr:{t:'20 000 frayeurs sous les mers',d:'Descends dans les Abysses.'}},
    {code:'fish_water',tier:'bronze',en:{t:'Like a Fish to Water',d:'Master the currents.'}, fr:{t:'Comme un poisson dans l’eau',d:'Maîtrise les courants.'}},
    {code:'freeze_frame',tier:'silver',en:{t:'Freeze Frame!',d:'Stay still while it watches.'}, fr:{t:'Arrêt sur image !',d:'Reste immobile pendant qu’il regarde.'}},
    {code:'fear_deep',tier:'silver',en:{t:'Fear the Deep',d:'Reach the Sea Temple.'}, fr:{t:'Crains les profondeurs',d:'Atteins le Temple des Mers.'}},
    {code:'keep_swimming',tier:'bronze',en:{t:'Just Keep Swimming',d:'Escape without looking back.'}, fr:{t:'Continue de nager',d:'Fuis sans te retourner.'}},
    {code:'sweet_tooth',tier:'bronze',en:{t:'Sweet Tooth',d:'Taste what Candyland offers.'}, fr:{t:'Bec sucré',d:'Goûte à ce que Candyland propose.'}},
    {code:'no_dessert',tier:'bronze',en:{t:'No Room for Dessert',d:'Refuse the feast.'}, fr:{t:'Pas de place pour le dessert',d:'Refuse le festin.'}},
    {code:'piece_cake',tier:'bronze',en:{t:'Piece of Cake!',d:'Clear a trial without a single mistake.'}, fr:{t:'Les doigts dans le nez !',d:'Réussis une épreuve sans la moindre erreur.'}},
    {code:'gobstopper',tier:'silver',en:{t:'Everlasting Gobstopper',d:'Endure the endless trial.'}, fr:{t:'Le bonbon éternel',d:'Endure l’épreuve sans fin.'}},
    {code:'sugar_rush',tier:'bronze',en:{t:'Sugar Rush!',d:'Sprint through the sugar storm.'}, fr:{t:'Overdose de sucre !',d:'Sprinte à travers la tempête de sucre.'}},
    {code:'pure_imagination',tier:'silver',en:{t:'A Land of Pure Imagination',d:'See Candyland for what it is.'}, fr:{t:'Un monde de pure imagination',d:'Vois Candyland pour ce qu’il est vraiment.'}},
    ...
    {code:'king_underworld',tier:'gold',en:{t:'King of the Underworld',d:'Overthrow what rules below.'}, fr:{t:'Roi des Enfers',d:'Renverse ce qui règne en bas.'}},
    {code:'hollows_1',tier:'silver',hidden:true, en:{t:'Secret of the Hollows I',d:'The Hollows keep their secrets.'}, fr:{t:'Secret des Hollows I',d:'Les Hollows gardent leurs secrets.'}},
    {code:'hollows_2',tier:'silver',hidden:true, en:{t:'Secret of the Hollows II',d:'The Hollows keep their secrets.'}, fr:{t:'Secret des Hollows II',d:'Les Hollows gardent leurs secrets.'}},
    {code:'hollows_3',tier:'silver',hidden:true, en:{t:'Secret of the Hollows III',d:'The Hollows keep their secrets.'}, fr:{t:'Secret des Hollows III',d:'Les Hollows gardent leurs secrets.'}},
    {code:'hollows_4',tier:'silver',hidden:true, en:{t:'Secret of the Hollows IV',d:'The Hollows keep their secrets.'}, fr:{t:'Secret des Hollows IV',d:'Les Hollows gardent leurs secrets.'}},
    {code:'hollows_5',tier:'silver',hidden:true, en:{t:'Secret of the Hollows V',d:'The Hollows keep their secrets.'}, fr:{t:'Secret des Hollows V',d:'Les Hollows gardent leurs secrets.'}},
    {code:'last_goodbye',tier:'gold',en:{t:'My Last Goodbye',d:'Say the goodbye you never could.'}, fr:{t:'Mon dernier adieu',d:'Fais l’adieu que tu n’as jamais pu faire.'}},
    {code:'no_more_secrets',tier:'gold',en:{t:'No More Secrets',d:'Uncover every secret of the Hollows.'}, fr:{t:'Plus aucun secret',d:'Perce tous les secrets des Hollows.'}},
    {code:'real_soldier',tier:'gold',en:{t:'A Real Soldier!',d:'Finish SOUL REDEMPTION.'}, fr:{t:'Un vrai soldat !',d:'Termine SOUL REDEMPTION.'}},
    {code:'platinum',tier:'platinum',en:{t:'Trophy Hoarder',d:'Earn every other trophy.'}, fr:{t:'Collectionneur de trophées',d:'Obtiens tous les autres trophées.'}},
  ],
  ...
  'backrooms-liminal': [
    {
      ...
      body:{
        ...
        fr:'Le nouveau moteur de topologie garantit qu’aucun couloir ne se répète au sein d’une même partie — et le bourdonnement des néons te suit désormais d’un niveau à l’autre. Porte des écouteurs.',
...
const I18N = {
  fr:{
    ...
    worksTitle:'NOS\nŒUVRES',worksDesc:'Huit titres. Quatre films interactifs. Quatre jeux vidéo. Chacun est un monde forgé avec intention.',
    ...
    aboutTitle:'À PROPOS\nDE NOUS',
    aboutEye:'Le studio',
    aboutDesc:'Rencontrez les personnes derrière les mondes — celles qui créent des expériences qui enseignent, émeuvent et hantent l’esprit.',
    teamEye:'L’équipe',
    teamTitle:'QUI\nNOUS SOMMES',
    ...
    stripQuotes:['« Nous ne faisons pas de jeux. Nous construisons des mondes qui laissent des traces sur ceux qui y entrent. »','« De l’horreur à la célébration — chaque expérience que nous créons porte une vérité humaine singulière. »','« Des jeux qui enseignent. Des jeux qui émeuvent. Des jeux qui hantent l’esprit longtemps après que l’écran s’est éteint. »'],
    stripTags:['GeekLearn Games — Est. 2026','Films interactifs et jeux vidéo','Manifeste du studio'],
    ...
    marqueeWords:['GeekLearn Games','Films interactifs','Jeux vidéo','Est. 2026','France','Des jeux qui enseignent','Des jeux qui émeuvent','Des jeux qui hantent'],
  },
  en:{
  ...
  es:{
    nav:['Inicio','Nuestras Obras','Tienda','Sobre Nosotros','Contacto'],
  ...
  de:{
    nav:['Startseite','Unsere Werke','Shop','Über Uns','Kontakt'],
  ...
  ar:{
    nav:['الرئيسية','أعمالنا','المتجر','من نحن','تواصل معنا'],
  ...
  ja:{
    nav:['ホーム','作品一覧','ショップ','私たちについて','お問い合わせ'],
  ...
  ru:{
    nav:['Главная','Наши Работы','Магазин','О нас','Контакт'],
  ...
  pl:{
    nav:['Strona główna','Nasze Prace','Sklep','O Nas','Kontakt'],
  ...
  it:{
    nav:['Home','Le Nostre Opere','Negozio','Chi Siamo','Contatto'],
